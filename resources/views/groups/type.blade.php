                ...
                <div class="pagetitle">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><u>ชนิดอุปกรณ์</u></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="float-end">
                            ...
                            <form id="frm-add-type">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="staticBackdropLabel">ชื่อชนิดอุปกรณ์</h1>
                                    ...
                                    <div class="modal-body">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="type_name"
                                                placeholder="พิมพ์ชื่อชนิด" aria-label="พิมพ์ชื่อชนิด"
                                                aria-describedby="basic-addon1" required>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <input type="hidden" value="{{ $groups->groups_id }}" name="groups_id">
                    ...
                    <script>
                        $(document).ready(function() {
                            $("#frm-add-type").submit(function(e) {
                                e.preventDefault();

                                var formData = $(this).serialize();

                                $.ajax({
                                    url: "{{ route('frmAddType') }}",
                                    type: "POST",
                                    data: formData,
            ...
            <table class="table table-hover" id="data-table">
                <thead>
                    <tr class="text-center">
                        <th scope="col">#</th>
                        <th scope="col">ชื่อชนิดอุปกรณ์</th>
                        <th scope="col">เพิ่มแบรนด์</th>
                ...
                <tbody>
                    ...
                    @foreach ($type as $t)
                        ...
                        <tr>
                            ...
                            <td class="searchable-column">{{ $t->type_name }}</td>
                            <td class="text-center">
                                <a href="{{ route('brand', ['groupsId' => $groups->groups_id, 'typeId' => $t->type_id]) }}"
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#editType{{ $i }}"><i class="bi bi-pencil"></i></button>
                                <!-- Modal -->
                                <div class="modal fade" id="editType{{ $i }}" data-bs-backdrop="static"
                                    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <form id="frm-edit-type{{ $i }}">
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text" id="basic-addon1">ชื่อ</span>
                                                        <input type="text" class="form-control" name="edit_type_name"
                                                            value="{{ $t->type_name }}" aria-describedby="basic-addon1">
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <input type="hidden" value="{{ $t->type_id }}"
                                                        name="edit_type_id">
                                ...
                                <script>
                                    $(document).ready(function() {
                                        $("#frm-edit-type" + <?php echo $i; ?>).submit(function(e) {
                                            e.preventDefault();

                                            var formData = $(this).serialize();

                                            $.ajax({
                                                url: "{{ route('frmEditType') }}",
                                                type: "POST",
                                                data: formData,
                                                success: function(response) {
